...
const ACTION_STYLES = {
  ...
  search_pappers:  { bg: '#FFF7ED', color: '#9A3412', border: '#FED7AA', label: 'Recherche entreprise (Pappers, ancien)' },
  search_entreprise: { bg: '#FFF7ED', color: '#9A3412', border: '#FED7AA', label: 'Recherche entreprise' },
