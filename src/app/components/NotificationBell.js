  ...
  return (
    <div
      ...
      style={{
        ...
        borderRadius: 12,
        boxShadow: '0 14px 36px rgba(15,23,42,0.16), inset 0 1px 0 rgba(255,255,255,0.55)',
        cursor: 'pointer',
        display: 'flex',
      ...
      <div ref={ref} style={{ position: 'relative', display: 'inline-block' }}>
        ...
        {open && (
          <div style={{
            ...
            boxShadow: '0 24px 60px rgba(15,23,42,0.18), inset 0 1px 0 rgba(255,255,255,0.55)',
