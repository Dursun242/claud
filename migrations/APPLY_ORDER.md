...
| 029 | `029_crm_devis_signature.sql` | Colonnes `odoo_sign_id` / `odoo_sign_url` / `statut_signature` sur `crm_devis` : signature électronique des devis via Odoo Sign. Voir `029_README.md`. |
