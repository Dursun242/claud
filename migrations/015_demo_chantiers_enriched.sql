-- ══════════════════════════════════════════════════════════════
-- MIGRATION 015 — Démo enrichie : 3 chantiers types MOE
-- ══════════════════════════════════════════════════════════════
-- Remplace seed_demo_data() pour offrir une démo qui couvre :
--   1. Rénovation (Villa Moreau)
--   2. Construction neuve (Maison Petit, 200 k€)
--   3. Aménagement commercial (Pharmacie Normandie, 500 m²)
--
-- Chaque chantier illustre des cas de figure différents : phases,
-- statuts OS, signatures, lots, budgets, tâches.
-- ══════════════════════════════════════════════════════════════
...
BEGIN
  ...
  VALUES (v_ch1, 'Villa Moreau — Rénovation complète', 'DémoMOA',
    ...
    'Gros œuvre', 'En cours', 420000, 0, '2026-01-15', '2026-09-30',
  ...
  -- ═══ 2. CONSTRUCTION NEUVE : Maison Petit (200 000 €) ═══════════
  INSERT INTO chantiers (id, nom, client, adresse, phase, statut, budget, depenses, date_debut, date_fin, lots)
  VALUES (v_ch2, 'Maison Petit — Construction neuve 120 m²', 'DémoMOA',
    'Lot n°14, Chemin des Falaises, 76310 Sainte-Adresse',
    'Études', 'Planifié', 200000, 0, '2026-05-01', '2027-03-31',
    ARRAY['Terrassement','VRD','Gros œuvre','Charpente','Couverture','Menuiseries','Isolation','Électricité','Plomberie','Peinture','Carrelage']);
  ...
  INSERT INTO ordres_service (numero, chantier_id, artisan_nom, artisan_specialite, artisan_email, artisan_tel, date_emission, date_intervention, montant_ht, montant_tva, montant_ttc, statut, statut_signature, prestations, client_nom) VALUES
    ('DEMO-NEUF-001', v_ch2, 'EuroTP', 'Terrassement / VRD', 'contact@eurotp-demo.fr', '02 35 55 12 34',
     ...
     '[{"description":"Terrassement général + évacuation terres","unite":"m³","quantite":180,"prix_unitaire":85,"tva_taux":20},{"description":"Raccordement réseaux (eau, élec, télécom)","unite":"forfait","quantite":1,"prix_unitaire":100,"tva_taux":20}]'::jsonb, 'Famille Petit'),
  ...
  -- ═══ 3. COMMERCE 500 m² : Pharmacie Normandie ═══════════════════
  INSERT INTO chantiers (id, nom, client, adresse, phase, statut, budget, depenses, date_debut, date_fin, lots)
  VALUES (v_ch3, 'Pharmacie Normandie — Aménagement commerce 500 m²', 'DémoMOA',
    '42 avenue René Coty, 76600 Le Havre',
    'Technique', 'En cours', 380000, 0, '2026-02-01', '2026-06-15',
    ARRAY['Démolition','Cloisons','Faux-plafonds','Électricité CFO/CFA','CVC / Climatisation','Plomberie','Revêtements sols','Peinture','Enseigne','Mobilier']);
